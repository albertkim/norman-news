    ...
    <div className='container'>
      ...
      <div className='d-flex'>
        ...
        <div className='border border-light bg-light p-4' style={{width: 1000}}>
          ...
          <hr />
          <div className='d-flex'>
            <h1 className='display-4 mr-2'>1</h1>
            <div>Shots heard by York Landing, Man., residents used as a police communication tool, RCMP commander explains</div>
          </div>
          <div>Title 1</div>
          <div>Title 2</div>
          <div>Title 3</div>
